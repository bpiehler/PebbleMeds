...
// AppMessage key IDs — generated by the SDK build from the messageKeys array
// in package.json.  #include brings in extern uint32_t MESSAGE_KEY_* symbols
// defined in build/src/message_keys.auto.c (values start at 10000).
